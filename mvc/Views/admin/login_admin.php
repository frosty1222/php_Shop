            ...
            <div class="col-md-12 main3">
                ...
                <form action="#" method="POST" role="form">
                    ...
                    <div class="form-group">
                        <input type="email" name="email" value="<?php echo $email?>" placeholder="fill your email...">
                    </div>
                    ...
                    <div class="form-group">
                        <input type="phone" name="phone" value="<?php echo $phone ?>" placeholder="Enter your phone number...">
                    </div>
                    <div class="form-group">
