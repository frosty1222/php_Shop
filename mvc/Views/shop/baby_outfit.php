                ...
                <div class="grid-container2">
                    <?php foreach ($data as $pro) { ?>
                        <div class="deal-rightmk left-side">
                            <h3 class="agileits-sear-head">BaBy Shirt</h3>
                        ...
                        <nav aria-label="navigation">
                            <ul class="pagination">
                                ...
                                <?php for ($i = 1; $i <= $pages; $i++) { ?>
                                    <li class="page-item"><a class="page-link" href="index.php?controller=Branch&run=baby_outfit&pages=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                <?php  } ?>
                                <li class="page-item">
